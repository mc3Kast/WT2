...
public class ValueValidatorFactory {
    ...
    private ValueValidatorFactory() {
        ...
        map.put(List.of(SearchCriteria.Oven.HEIGHT.name(), SearchCriteria.Oven.WIDTH.name(),
                        ...
                        SearchCriteria.Refrigerator.WIDTH.name(),SearchCriteria.Kettle.HEIGHT.name(), 
                        SearchCriteria.Kettle.WIDTH.name()), new DoubleValidator());
        ...
        map.put(List.of(SearchCriteria.Oven.POWER_CONSUMPTION.name(), SearchCriteria.Oven.WEIGHT.name(),
                        ...
                        SearchCriteria.Speakers.NUMBER_OF_SPEAKERS.name(), SearchCriteria.Speakers.CORD_LENGTH.name(),
                        SearchCriteria.Kettle.CORD_LENGTH.name(),SearchCriteria.Kettle.POWER_CONSUMPTION.name()), new IntValidator());
